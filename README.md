...
* **uploads.sh**, which automatically creates the uploads folder for new projects in the right place on the server, and creates a symlink to it in your project's wp-content folder. (Not yet tested on the new server but should work)
